...
const skillCategories = [
  { label: "Ninjutsu", subtitle: "Frontend Arts", skills: ["React", "Next.js", "Angular", "HTML/CSS", "Tailwind CSS", "Framer Motion"], color: "from-[#ff6b00] to-[#ff8c00]" },
  { label: "Genjutsu", subtitle: "Backend Arts", skills: ["Laravel", "Node.js", "PHP", "Python", "MySQL", "Supabase"], color: "from-[#e63946] to-[#ff6b00]" },
  { label: "Taijutsu", subtitle: "Tools & More", skills: ["React Native", "C# / WPF", "TypeScript", "Git/GitHub", "OpenRouter API", "Three.js"], color: "from-[#ffd166] to-[#ff8c00]" },
];
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-display font-bold tracking-tight">
            <span className="text-text-primary">Jutsu </span>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {skillCategories.map((cat, catIdx) => (
            <motion.div
              ...
              className="glass-card rounded-2xl p-6 group hover:border-[#ff6b00]/30 transition-all duration-300"
            >
              <div className="flex items-center gap-3 mb-6">
                <div className={`w-8 h-1 rounded-full bg-gradient-to-r ${cat.color}`} />
                <div className="flex flex-col">
                  <span className="text-sm font-mono text-text-primary uppercase tracking-wider font-bold">{cat.label}</span>
                  <span className="text-[10px] font-mono text-text-muted">{cat.subtitle}</span>
                </div>
              </div>
              <motion.div
